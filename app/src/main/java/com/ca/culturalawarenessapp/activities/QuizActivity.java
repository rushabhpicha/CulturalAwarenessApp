...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewQuestion.setTypeface(latoBold);
        textViewScore.setTypeface(latoBold);
        textViewQuestionCount.setTypeface(latoBold);
        textViewCategory.setTypeface(latoBold);
        textViewDifficulty.setTypeface(latoBold);
        tvCountDown.setTypeface(latoBold);
        rb1.setTypeface(latoBold);
        rb2.setTypeface(latoBold);
        rb3.setTypeface(latoBold);
